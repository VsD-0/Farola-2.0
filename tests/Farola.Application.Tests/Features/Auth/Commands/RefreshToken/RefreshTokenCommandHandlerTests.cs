...
namespace Farola.Application.Tests.Features.Auth.Commands.RefreshToken
{
    public class RefreshTokenCommandHandlerTests
    {
        ...
        public async Task Handle_ValidRefreshToken_ReturnsNewTokens()
        {
            ...
            var storedToken = new Farola.Domain.Entities.RefreshToken
            {
            ...
            _refreshTokenRepo.Verify(r => r.AddAsync(It.Is<Farola.Domain.Entities.RefreshToken>(t =>
        ...
        public async Task Handle_InvalidOrExpiredToken_ThrowsUnauthorized()
        {
            ...
            _refreshTokenRepo.Setup(r => r.GetByTokenAsync(refreshTokenValue, It.IsAny<CancellationToken>()))
                .ReturnsAsync((Farola.Domain.Entities.RefreshToken?)null);
